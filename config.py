...
#############################################################
parser.add_argument('--result_root', type=str, default='/home/chenlb/compare_model/FREE/result', help='root path for saving checkpoint')
...
parser.add_argument('--nclass_seen', type=int, default=4, help='number of seen classes')
