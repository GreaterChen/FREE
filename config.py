...
parser.add_argument('--nz', type=int, default=768, help='size of the latent z vector')
...
#############################################################
parser.add_argument('--result_root', type=str, default='/home/LAB/chenlb24/compare_model/FREE/zero-shot-images/result', help='root path for saving checkpoint')
...
parser.add_argument('--nclass_seen', type=int, default=2, help='number of seen classes')
