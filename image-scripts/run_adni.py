...
--nepoch 501 --ngh 4096 --ndh 4096 --lr 0.0001 --classifier_lr 0.001 --lambda1 10 --critic_iter 1 --dataroot /home/LAB/chenlb24/ADNI --dataset ADNI \
 --a1 1 --a2 1 --feed_lr 0.00001 --dec_lr 0.0001 --loop 2 \
--nclass_all 3 --nclass_seen 2 --batch_size 32 --nz 768 --latent_size 312 --attSize 768 --resSize 2048  \
